  ...
  return (
    <nav className="sticky top-0 z-50 w-full glass-card border-b border-white/5 py-4">
      <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
        ...
        <div>
          <button className="bg-accent-600 hover:bg-accent-500 text-white px-5 py-2 rounded-full text-sm font-semibold transition-all shadow-[0_0_15px_rgba(20,184,166,0.3)] hover:shadow-[0_0_25px_rgba(20,184,166,0.5)] flex items-center gap-2">
